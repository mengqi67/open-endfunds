...
<template>
    <div class="page-main">
        <div class="page-title">投委会决策-3</div>
        <Card :bordered="false" shadow>
            ...
            <div class="option-wrap">
                ...
                <div class="right">
                    <router-link to="/investment-committee/new"><Button type="primary">新建</Button></router-link>
...
function goDetail() {
    router.push('/investment-committee/detail')
}
function refresh() {
    loading.value = true
    setTimeout(() => {
