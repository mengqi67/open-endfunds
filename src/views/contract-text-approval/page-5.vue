...
<template>
    <div class="page-main">
        <div class="page-title">合同文本审定-5</div>
        <Card :bordered="false" shadow>
            ...
            <div class="option-wrap">
                ...
                <div class="right">
                    <router-link to="/contract-text-approval/new"><Button type="primary">新建</Button></router-link>
...
function goDetail() {
    router.push('/contract-text-approval/detail')
}
function refresh() {
    loading.value = true
    setTimeout(() => {
