...
<template>
    <div class="page-main">
        <div class="page-title">立项方案信息管理</div>
        <Card :bordered="false" shadow>
            ...
            <div class="option-wrap">
                ...
                <div class="right">
                    <router-link to="/intermediary-hiring/new"><Button type="primary">新建</Button></router-link>
...
function goDetail() {
    router.push('/intermediary-hiring/detail')
}
function refresh() {
    loading.value = true
    setTimeout(() => {
