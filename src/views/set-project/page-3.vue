...
<template>
    <div class="page-main">
        <div class="page-title">份额流水查询</div>
        <Card :bordered="false" shadow>
            <div class="container">
                ...
                <div  class="box">               
                 业务类型：<Input v-model="fundName" style="width: 200px" />
                </div>
             ...
             <div class="container">
                <div class="box">
                发生日期：<Input v-model="fundName"   style="width: 200px" />-<Input v-model="fundName"   style="width: 200px" />
