...
<template>
    <div class="page-main">
        ...
        <Card :bordered="false" shadow>
            <div>
                <Input v-model="fundName" icon="ios-search" placeholder="操作员代码/操作员名称" style="width: 200px" />
            ...
            <div class="option-wrap">
                ...
                <div class="right">
                    <router-link to="/account-management/new-2"><Button type="primary">新建</Button></router-link>                    
            ...
            <br>
            <div class="page-wrap"><Page :total="3" show-total/></div>
        </Card>
        <Modal
            v-model="modal"
            title="导入"
